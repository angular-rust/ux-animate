...
use crate::{
    ...
    CrossingEvent, Effect, Event, InternalColor, InternalRect, KeyEvent, LayoutManager, Margin,
    Matrix, MotionEvent, OffscreenRedirect, Orientation, PaintVolume, RequestMode, RgbaColor,
    RotateAxis, ScalingFilter, ScrollEvent, Stage, TextDirection, Transition, Vertex,
};
...
pub trait ActorExt: 'static {
    ...
    fn get_background_color(&self) -> InternalColor;
