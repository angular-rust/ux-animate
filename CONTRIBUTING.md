...
[![](https://dudochkin-victor.github.io/assets/star-me-wide.svg)](https://github.com/angular-rust/ux-animate)
...
```
git clone git@github.com:$USER/ux-animate.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-animate` repository on GitHub to your computer.
